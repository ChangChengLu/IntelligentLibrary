...
*/
@Component("platinumVipDiscountStrategy")
public class PlatinumVipDiscountStrategy implements IVipDiscountStrategy {

    @Override
    public BigDecimal doPayDisCount(BigDecimal currentMoney) {
        return currentMoney.multiply(BigDecimal.valueOf(VipConstant.PLATINUM_DISCOUNT_RATE));
    }
